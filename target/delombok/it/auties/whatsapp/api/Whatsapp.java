// Generated by delombok at Sun Apr 16 21:33:55 CEST 2023
...
public class Whatsapp {
    ...
    public Whatsapp addListener(@NonNull Listener listener) {
        if (listener == null) {
            throw new java.lang.NullPointerException("listener is marked non-null but is null");
        }
        Validate.isTrue(hasRegisterSlotAvailable(), "The number of listeners is too high: expected %s, got %s", socketHandler.options().listenersLimit(), socketHandler.store().listeners().size());
        socketHandler.store().listeners().add(listener);
        return this;
    }

    private boolean hasRegisterSlotAvailable() {
        return socketHandler.options().listenersLimit() < 0 || store().listeners().size() + 1 <= socketHandler.options().listenersLimit();
    }
    ...
    public static Whatsapp newConnection(@NonNull WhatsappOptions options, @NonNull Store store, @NonNull Keys keys) {
        ...
        if (store == null) {
            throw new java.lang.NullPointerException("store is marked non-null but is null");
        }
        if (keys == null) {
            throw new java.lang.NullPointerException("keys is marked non-null but is null");
        }
    ...
    public static Stream<Whatsapp> streamConnections(@NonNull WhatsappOptions options) {
        ...
        return options.deserializer().findIds(options.clientType()).stream().map(id -> Whatsapp.newConnection(options.uuid(id)));
    }
    ...
    public Whatsapp addMessageReplyListener(@NonNull MessageInfo info, @NonNull OnMessageReply onMessageReply) {
        ...
        if (onMessageReply == null) {
            throw new java.lang.NullPointerException("onMessageReply is marked non-null but is null");
        }
    ...
    public Whatsapp addUserNameChangeListener(@NonNull OnUserNameChange onUserNameChange) {
        if (onUserNameChange == null) {
            throw new java.lang.NullPointerException("onUserNameChange is marked non-null but is null");
        }
    ...
    public Whatsapp addUserNameChangeListener(@NonNull OnWhatsappUserNameChange onNameChange) {
        if (onNameChange == null) {
            throw new java.lang.NullPointerException("onNameChange is marked non-null but is null");
        }
    ...
    public Whatsapp addUserStatusChangeListener(@NonNull OnUserAboutChange onUserAboutChange) {
        if (onUserAboutChange == null) {
            throw new java.lang.NullPointerException("onUserAboutChange is marked non-null but is null");
        }
    ...
    public Whatsapp addUserStatusChangeListener(@NonNull onWhatsappUserAboutChange onUserStatusChange) {
        if (onUserStatusChange == null) {
            throw new java.lang.NullPointerException("onUserStatusChange is marked non-null but is null");
        }
    ...
    public Whatsapp addUserPictureChangeListener(@NonNull OnUserPictureChange onUserPictureChange) {
        if (onUserPictureChange == null) {
            throw new java.lang.NullPointerException("onUserPictureChange is marked non-null but is null");
        }
    ...
    public Whatsapp addContactPictureChangeListener(@NonNull OnContactPictureChange onContactPictureChange) {
        if (onContactPictureChange == null) {
            throw new java.lang.NullPointerException("onContactPictureChange is marked non-null but is null");
        }
    ...
    public Whatsapp addContactPictureChangeListener(@NonNull OnWhatsappContactPictureChange onProfilePictureChange) {
        if (onProfilePictureChange == null) {
            throw new java.lang.NullPointerException("onProfilePictureChange is marked non-null but is null");
        }
    ...
    public Whatsapp addGroupPictureChangeListener(@NonNull OnGroupPictureChange onGroupPictureChange) {
        if (onGroupPictureChange == null) {
            throw new java.lang.NullPointerException("onGroupPictureChange is marked non-null but is null");
        }
    ...
    public Whatsapp addContactBlockedListener(@NonNull OnContactBlocked onContactBlocked) {
        if (onContactBlocked == null) {
            throw new java.lang.NullPointerException("onContactBlocked is marked non-null but is null");
        }
    ...
    public final <T extends ContactJidProvider> CompletableFuture<Whatsapp> changePrivacySetting(@NonNull PrivacySettingType type, @NonNull PrivacySettingValue value, @NonNull T @NonNull ... excluded) {
        ...
        if (value == null) {
            throw new java.lang.NullPointerException("value is marked non-null but is null");
        }
        if (excluded == null) {
            throw new java.lang.NullPointerException("excluded is marked non-null but is null");
        }
        checkLoggedIn();
        ...
        var attributes = Attributes.of().put("name", type.data()).put("value", value.data()).put("dhash", "none", () -> value == PrivacySettingValue.CONTACTS_EXCEPT).toMap();
        var excludedJids = Arrays.stream(excluded).map(ContactJidProvider::toJid).toList();
        var children = value != PrivacySettingValue.CONTACTS_EXCEPT ? null : excludedJids.stream().map(entry -> Node.ofAttributes("user", Map.of("jid", entry, "action", "add"))).toList();
        return socketHandler.sendQuery("set", "privacy", Node.ofChildren("privacy", Node.ofChildren("category", attributes, children))).thenRunAsync(() -> onPrivacyFeatureChanged(type, value, excludedJids)).thenApply(ignored -> this);
    }
    ...
    public CompletableFuture<Whatsapp> changeNewChatsEphemeralTimer(@NonNull ChatEphemeralTimer timer) {
        if (timer == null) {
            throw new java.lang.NullPointerException("timer is marked non-null but is null");
        }
        checkLoggedIn();
        return socketHandler.sendQuery("set", "disappearing_mode", Node.ofAttributes("disappearing_mode", Map.of("duration", timer.period().toSeconds()))).thenRunAsync(() -> store().newChatsEphemeralTimer(timer)).thenApply(ignored -> this);
    }
    ...
    public CompletableFuture<Whatsapp> createGdprAccountInfo() {
        checkLoggedIn();
        return socketHandler.sendQuery("get", "urn:xmpp:whatsapp:account", Node.ofAttributes("gdpr", Map.of("gdpr", "request"))).thenApply(ignored -> this);
    }
    ...
    public CompletableFuture<GdprAccountReport> getGdprAccountInfoStatus() {
        checkLoggedIn();
        return socketHandler.sendQuery("get", "urn:xmpp:whatsapp:account", Node.ofAttributes("gdpr", Map.of("gdpr", "status"))).thenApplyAsync(result -> GdprAccountReport.ofPending(result.attributes().getLong("timestamp")));
    }
    ...
    public CompletableFuture<Whatsapp> changeName(@NonNull String newName) {
        if (newName == null) {
            throw new java.lang.NullPointerException("newName is marked non-null but is null");
        }
        checkLoggedIn();
        var oldName = socketHandler.store().name();
        return socketHandler.send(Node.ofChildren("presence", Map.of("name", newName))).thenRunAsync(() -> socketHandler.updateUserName(newName, oldName)).thenApply(ignored -> this);
    }
    ...
    public CompletableFuture<Whatsapp> changeStatus(@NonNull String newStatus) {
        if (newStatus == null) {
            throw new java.lang.NullPointerException("newStatus is marked non-null but is null");
        }
        checkLoggedIn();
        return socketHandler.sendQuery("set", "status", Node.of("status", newStatus.getBytes(StandardCharsets.UTF_8))).thenRunAsync(() -> store().name(newStatus)).thenApply(ignored -> this);
    }
    ...
    public <T extends ContactJidProvider> CompletableFuture<T> subscribeToPresence(@NonNull T jid) {
        if (jid == null) {
            throw new java.lang.NullPointerException("jid is marked non-null but is null");
        }
        checkLoggedIn();
    ...
    public CompletableFuture<MessageInfo> sendReaction(@NonNull MessageMetadataProvider message, String reaction) {
        ...
        checkLoggedIn();
        var key = MessageKey.builder().chatJid(message.chat().jid()).senderJid(message.senderJid()).fromMe(Objects.equals(message.senderJid().toWhatsappJid(), store().jid().toWhatsappJid())).id(message.id()).build();
        var reactionMessage = ReactionMessage.builder().key(key).content(reaction).timestamp(Instant.now().toEpochMilli()).build();
    ...
    public CompletableFuture<MessageInfo> sendMessage(@NonNull ContactJidProvider chat, @NonNull MessageContainer message) {
        ...
        var key = MessageKey.builder().chatJid(chat.toJid()).fromMe(true).senderJid(store().jid()).build();
        var info = MessageInfo.builder().senderJid(store().jid()).key(key).message(message).timestampSeconds(Clock.nowSeconds()).broadcast(chat.toJid().hasServer(BROADCAST)).build();
    ...
    public CompletableFuture<MessageInfo> sendMessage(@NonNull MessageInfo info) {
        ...
        return attributeMessageMetadata(info).thenComposeAsync(ignored -> socketHandler.sendMessage(MessageSendRequest.of(info))).thenApplyAsync(ignored -> info);
    }
    ...
    private void fixEphemeralMessage(MessageInfo info) {
        ...
        if (info.chat().isEphemeral()) {
            info.message().contentWithContext().map(ContextualMessage::contextInfo).ifPresent(contextInfo -> createEphemeralContext(info.chat(), contextInfo));
    ...
    private void attributeTextMessage(TextMessage textMessage) {
        ...
        var imageUri = match.result().images().stream().reduce(this::compareDimensions).map(LinkPreviewMedia::uri).orElse(null);
        var videoUri = match.result().videos().stream().reduce(this::compareDimensions).map(LinkPreviewMedia::uri).orElse(null);
    ...
    private CompletableFuture<Void> attributeMediaMessage(MediaMessage mediaMessage) {
        return Medias.upload(mediaMessage.decodedMedia().get(), mediaMessage.mediaType().toAttachmentType(), store().mediaConnection()).thenAccept(upload -> attributeMediaMessage(mediaMessage, upload));
    }
    ...
    private void attributePollUpdateMessage(MessageInfo info, PollUpdateMessage pollUpdateMessage) {
        ...
        var additionalData = "%s\000%s".formatted(pollUpdateMessage.pollCreationMessageKey().id(), store().jid().toWhatsappJid());
        ...
        var originalPollInfo = socketHandler.store().findMessageByKey(pollUpdateMessage.pollCreationMessageKey()).orElseThrow(() -> new NoSuchElementException("Missing original poll message"));
        ...
        var useSecretPayload = Bytes.of(pollUpdateMessage.pollCreationMessageKey().id()).append(originalPollSender).append(modificationSender).append(secretName).toByteArray();
    ...
    private CompletableFuture<Void> attributeButtonMessage(MessageInfo info, ButtonMessage buttonMessage) {
        return switch (buttonMessage) {
            case ButtonsMessage buttonsMessage && buttonsMessage.header().isPresent() && buttonsMessage.header().get() instanceof MediaMessage mediaMessage -> attributeMediaMessage(mediaMessage);
            case TemplateMessage templateMessage && templateMessage.format().isPresent() -> switch (templateMessage.format().get()) {
                case FourRowTemplate fourRowTemplate && fourRowTemplate.title().isPresent() && fourRowTemplate.title().get() instanceof MediaMessage mediaMessage -> attributeMediaMessage(mediaMessage);
                case HydratedFourRowTemplate hydratedFourRowTemplate && hydratedFourRowTemplate.title().isPresent() && hydratedFourRowTemplate.title().get() instanceof MediaMessage mediaMessage -> attributeMediaMessage(mediaMessage);
                default -> CompletableFuture.completedFuture(null);
            };
            case InteractiveMessage interactiveMessage && interactiveMessage.header().isPresent() && interactiveMessage.header().get().attachment().isPresent() && interactiveMessage.header().get().attachment().get() instanceof MediaMessage mediaMessage -> attributeMediaMessage(mediaMessage);
            default -> CompletableFuture.completedFuture(null);
        };
    }
    ...
    private void attributeGroupInviteMessage(MessageInfo info, GroupInviteMessage groupInviteMessage) {
        ...
        var preview = LinkPreview.createPreview(URI.create(url)).stream().map(LinkPreviewResult::images).map(Collection::stream).map(Stream::findFirst).flatMap(Optional::stream).findFirst().map(LinkPreviewMedia::uri).orElse(null);
        var replacement = TextMessage.builder().text(groupInviteMessage.caption() != null ? "%s: %s".formatted(groupInviteMessage.caption(), url) : url).description("WhatsApp Group Invite").title(groupInviteMessage.groupName()).previewType(NONE).thumbnail(readURI(preview)).matchedText(url).canonicalUrl(url).build();
    ...
    private CompletableFuture<Void> markAllAsRead(ContactJidProvider chat) {
        var all = socketHandler.store().findChatByJid(chat.toJid()).stream().map(Chat::unreadMessages).flatMap(Collection::stream).map(this::markRead).toArray(CompletableFuture[]::new);
    ...
    public CompletableFuture<MessageInfo> sendMessage(@NonNull ContactJidProvider chat, @NonNull String message, @NonNull MessageMetadataProvider quotedMessage) {
        ...
        if (quotedMessage == null) {
            throw new java.lang.NullPointerException("quotedMessage is marked non-null but is null");
        }
    ...
    public CompletableFuture<MessageInfo> sendMessage(@NonNull ContactJidProvider chat, @NonNull ContextualMessage message, @NonNull ContextInfo contextInfo) {
        ...
        if (contextInfo == null) {
            throw new java.lang.NullPointerException("contextInfo is marked non-null but is null");
        }
    ...
    public CompletableFuture<HasWhatsappResponse> hasWhatsapp(@NonNull ContactJidProvider contact) {
        if (contact == null) {
            throw new java.lang.NullPointerException("contact is marked non-null but is null");
        }
    ...
    public CompletableFuture<Map<ContactJid, HasWhatsappResponse>> hasWhatsapp(@NonNull ContactJidProvider... contacts) {
        if (contacts == null) {
            throw new java.lang.NullPointerException("contacts is marked non-null but is null");
        }
        checkLoggedIn();
        var contactNodes = Arrays.stream(contacts).map(jid -> Node.ofChildren("user", Node.of("contact", jid.toJid().toPhoneNumber()))).toArray(Node[]::new);
        return socketHandler.sendInteractiveQuery(Node.of("contact"), contactNodes).thenApplyAsync(this::parseHasWhatsappResponse);
    }
    ...
    public CompletableFuture<Optional<BusinessProfile>> queryBusinessProfile(@NonNull ContactJidProvider contact) {
        ...
        checkLoggedIn();
        return socketHandler.sendQuery("get", "w:biz", Node.ofChildren("business_profile", Node.of("v", "116"), Node.ofAttributes("profile", Map.of("jid", contact.toJid())))).thenApplyAsync(this::getBusinessProfile);
    }
    ...
    public CompletableFuture<List<BusinessCategory>> queryBusinessCategories() {
        checkLoggedIn();
        return socketHandler.sendQuery("get", "fb:thrift_iq", Node.of("request", Map.of("op", "profile_typeahead", "type", "catkit", "v", "1"), Node.ofChildren("query", List.of()))).thenApplyAsync(Whatsapp::parseBusinessCategories);
    }
    ...
    public CompletableFuture<String> queryGroupInviteCode(@NonNull ContactJidProvider chat) {
        ...
        checkLoggedIn();
        return socketHandler.sendQuery(chat.toJid(), "get", "w:g2", Node.of("invite")).thenApplyAsync(Whatsapp::parseInviteCode);
    }

    private static String parseInviteCode(Node result) {
        return result.findNode("invite").orElseThrow(() -> new NoSuchElementException("Missing invite countryCode in invite response")).attributes().getRequiredString("code");
    }
    ...
    public CompletableFuture<Optional<Chat>> acceptGroupInvite(@NonNull String inviteCode) {
        if (inviteCode == null) {
            throw new java.lang.NullPointerException("inviteCode is marked non-null but is null");
        }
        checkLoggedIn();
        return socketHandler.sendQuery(Server.GROUP.toJid(), "set", "w:g2", Node.ofAttributes("invite", Map.of("code", inviteCode))).thenApplyAsync(this::parseAcceptInvite);
    }

    private Optional<Chat> parseAcceptInvite(Node result) {
        return result.findNode("group").flatMap(group -> group.attributes().getJid("jid")).map(jid -> store().findChatByJid(jid).orElseGet(() -> socketHandler.store().addChat(jid)));
    }
    ...
    public CompletableFuture<Boolean> changePresence(boolean available) {
        ...
        return socketHandler.sendWithNoResponse(node).thenAcceptAsync(socketHandler -> updateSelfPresence(null, presence)).thenApplyAsync(ignored -> available);
    }
    ...
    public <T extends ContactJidProvider> CompletableFuture<T> changePresence(@NonNull T chat, @NonNull ContactStatus presence) {
        ...
        if (presence == null) {
            throw new java.lang.NullPointerException("presence is marked non-null but is null");
        }
        checkLoggedIn();
        if (presence == ContactStatus.COMPOSING || presence == ContactStatus.RECORDING) {
            ...
            return socketHandler.sendWithNoResponse(node).thenAcceptAsync(socketHandler -> updateSelfPresence(chat, presence)).thenApplyAsync(ignored -> chat);
        }
    ...
    public CompletableFuture<List<ContactJid>> promote(@NonNull ContactJidProvider group, @NonNull ContactJidProvider @NonNull ... contacts) {
        if (group == null) {
            throw new java.lang.NullPointerException("group is marked non-null but is null");
        }
        if (contacts == null) {
            throw new java.lang.NullPointerException("contacts is marked non-null but is null");
        }
    ...
    private CompletableFuture<List<ContactJid>> executeActionOnGroupParticipant(ContactJidProvider group, GroupAction action, ContactJidProvider... jids) {
        checkLoggedIn();
        var body = Arrays.stream(jids).map(ContactJidProvider::toJid).map(jid -> Node.ofAttributes("participant", Map.of("jid", checkGroupParticipantJid(jid, "Cannot execute action on yourself")))).map(innerBody -> Node.ofChildren(action.data(), innerBody)).toArray(Node[]::new);
        return socketHandler.sendQuery(group.toJid(), "set", "w:g2", body).thenApplyAsync(result -> parseGroupActionResponse(result, action));
    }
    ...
    private List<ContactJid> parseGroupActionResponse(Node result, GroupAction action) {
        return result.findNode(action.data()).orElseThrow(() -> new NoSuchElementException("An erroneous group operation was executed")).findNodes("participant").stream().filter(participant -> !participant.attributes().hasKey("error")).map(participant -> participant.attributes().getJid("jid")).flatMap(Optional::stream).toList();
    }
    ...
    public <T extends ContactJidProvider> CompletableFuture<T> changeGroupDescription(@NonNull T group, String description) {
        ...
        checkLoggedIn();
        return socketHandler.queryGroupMetadata(group.toJid()).thenApplyAsync(GroupMetadata::descriptionId).thenComposeAsync(descriptionId -> changeGroupDescription(group, description, descriptionId)).thenApplyAsync(ignored -> group);
    }

    private CompletableFuture<Node> changeGroupDescription(ContactJidProvider group, String description, String descriptionId) {
        var descriptionNode = Optional.ofNullable(description).map(content -> Node.of("body", content.getBytes(StandardCharsets.UTF_8))).orElse(null);
        var attributes = Attributes.of().put("id", MessageKey.randomId(), () -> description != null).put("delete", true, () -> description == null).put("prev", descriptionId, () -> descriptionId != null).toMap();
    ...
    public <T extends ContactJidProvider> CompletableFuture<T> changeWhoCanSendMessages(@NonNull T group, @NonNull GroupPolicy policy) {
        ...
        if (policy == null) {
            throw new java.lang.NullPointerException("policy is marked non-null but is null");
        }
        checkLoggedIn();
    ...
    public <T extends ContactJidProvider> CompletableFuture<T> changeGroupPicture(@NonNull T group, byte[] image) {
        ...
        return socketHandler.sendQuery(group.toJid().toWhatsappJid(), "set", "w:profile:picture", body).thenApplyAsync(ignored -> group);
    }
    ...
    public CompletableFuture<GroupMetadata> createGroup(@NonNull String subject, @NonNull ContactJidProvider... contacts) {
        if (subject == null) {
            throw new java.lang.NullPointerException("subject is marked non-null but is null");
        }
        if (contacts == null) {
            throw new java.lang.NullPointerException("contacts is marked non-null but is null");
        }
    ...
    public CompletableFuture<GroupMetadata> createGroup(@NonNull String subject, @NonNull ChatEphemeralTimer timer, ContactJidProvider parentGroup, @NonNull ContactJidProvider... contacts) {
        ...
        Arrays.stream(contacts).map(contact -> Node.ofAttributes("participant", Map.of("jid", checkGroupParticipantJid(contact.toJid(), "Cannot create group with yourself as a participant")))).forEach(children::add);
        var body = Node.ofChildren("create", Map.of("subject", subject, "key", ofRandom(12).toHex()), children);
        return socketHandler.sendQuery(Server.GROUP.toJid(), "set", "w:g2", body).thenApplyAsync(response -> Optional.ofNullable(response).flatMap(node -> node.findNode("group")).orElseThrow(() -> new NoSuchElementException("Missing group response, something went wrong: %s".formatted(findErrorNode(response))))).thenApplyAsync(GroupMetadata::of);
    }

    private String findErrorNode(Node result) {
        return Optional.ofNullable(result).flatMap(node -> node.findNode("error")).map(Node::toString).orElse("unknown");
    }
    ...
    public CompletableFuture<Map<ContactJid, Boolean>> linkGroupsToCommunity(@NonNull ContactJidProvider community, @NonNull ContactJidProvider... groups) {
        if (community == null) {
            throw new java.lang.NullPointerException("community is marked non-null but is null");
        }
        if (groups == null) {
            throw new java.lang.NullPointerException("groups is marked non-null but is null");
        }
        checkLoggedIn();
        var body = Arrays.stream(groups).map(entry -> Node.ofAttributes("group", Map.of("jid", entry.toJid()))).toArray(Node[]::new);
        return socketHandler.sendQuery(community.toJid(), "set", "w:g2", Node.ofChildren("links", Node.ofChildren("link", Map.of("link_type", "sub_group"), body))).thenApplyAsync(result -> parseLinksResponse(result, groups));
    }
    ...
    private Map<ContactJid, Boolean> parseLinksResponse(Node result, @NonNull ContactJidProvider[] groups) {
        ...
        var success = result.findNode("links").stream().map(entry -> entry.findNodes("link")).flatMap(Collection::stream).filter(entry -> entry.attributes().hasKey("link_type", "sub_group")).map(entry -> entry.findNode("group")).flatMap(Optional::stream).map(entry -> entry.attributes().getJid("jid")).flatMap(Optional::stream).collect(Collectors.toUnmodifiableSet());
    ...
    public CompletableFuture<Boolean> unlinkGroupFromCommunity(@NonNull ContactJidProvider community, @NonNull ContactJidProvider group) {
        ...
        checkLoggedIn();
        return socketHandler.sendQuery(community.toJid(), "set", "w:g2", Node.ofChildren("unlink", Map.of("unlink_type", "sub_group"), Node.ofAttributes("group", Map.of("jid", group.toJid())))).thenApplyAsync(result -> parseUnlinkResponse(result, group));
    }
    ...
    public <T extends ContactJidProvider> CompletableFuture<T> mute(@NonNull T chat, @NonNull ChatMute mute) {
        ...
        if (mute == null) {
            throw new java.lang.NullPointerException("mute is marked non-null but is null");
        }
        checkLoggedIn();
    ...
    public <T extends ContactJidProvider> CompletableFuture<T> changeEphemeralTimer(@NonNull T chat, @NonNull ChatEphemeralTimer timer) {
        ...
        return switch (chat.toJid().server()) {
            case USER, WHATSAPP -> {
                var message = ProtocolMessage.builder().protocolType(ProtocolMessage.ProtocolMessageType.EPHEMERAL_SETTING).ephemeralExpiration(timer.period().toSeconds()).build();
                yield sendMessage(chat, message).thenApplyAsync(ignored -> chat);
            }
            case GROUP -> {
                var body = timer == ChatEphemeralTimer.OFF ? Node.of("not_ephemeral") : Node.ofAttributes("ephemeral", Map.of("expiration", timer.period().toSeconds()));
    ...
    private CompletableFuture<MessageInfo> star(MessageInfo info, boolean star) {
        ...
        var request = PatchRequest.of(REGULAR_HIGH, syncAction, SET, 3, info.chatJid().toString(), info.id(), fromMeToFlag(info), participantToFlag(info));
    ...
    public CompletableFuture<MessageInfo> delete(@NonNull MessageInfo info, boolean everyone) {
        ...
        checkLoggedIn();
        if (everyone) {
            var message = ProtocolMessage.builder().protocolType(ProtocolMessage.ProtocolMessageType.REVOKE).key(info.key()).build();
            ...
            var revokeInfo = MessageInfo.builder().senderJid(sender).key(key).message(MessageContainer.of(message)).timestampSeconds(Clock.nowSeconds()).build();
            var request = MessageSendRequest.builder().info(revokeInfo).additionalAttributes(Map.of("edit", info.chat().isGroup() && !info.fromMe() ? "8" : "7")).build();
    ...
    private CompletableFuture<String> changeBusinessAttribute(String key, String value) {
        checkLoggedIn();
        return socketHandler.sendQuery("set", "w:biz", Node.ofChildren("business_profile", Map.of("v", "3", "mutation_type", "delta"), Node.of(key, requireNonNullElse(value, "").getBytes(StandardCharsets.UTF_8)))).thenAcceptAsync(result -> checkBusinessAttributeConflict(key, value, result)).thenApplyAsync(ignored -> value);
    }
    ...
    private void checkBusinessAttributeConflict(String key, String value, Node result) {
        ...
        var actual = keyNode.get().contentAsString().orElseThrow(() -> new NoSuchElementException("Missing business %s response, something went wrong: %s".formatted(key, findErrorNode(result))));
    ...
    public CompletableFuture<String> changeBusinessEmail(String email) {
        Validate.isTrue(email == null || Pattern.compile("^(.+)@(\\\\S+)$").matcher(email).matches(), "Invalid email: %s", email);
    ...
    public CompletableFuture<List<BusinessCategory>> changeBusinessCategories(List<BusinessCategory> categories) {
        checkLoggedIn();
        return socketHandler.sendQuery("set", "w:biz", Node.ofChildren("business_profile", Map.of("v", "3", "mutation_type", "delta"), Node.ofChildren("categories", createCategories(categories)))).thenApplyAsync(ignored -> categories);
    }
    ...
    public CompletableFuture<List<URI>> changeBusinessWebsites(List<URI> websites) {
        checkLoggedIn();
        return socketHandler.sendQuery("set", "w:biz", Node.ofChildren("business_profile", Map.of("v", "3", "mutation_type", "delta"), createWebsites(websites))).thenApplyAsync(ignored -> websites);
    }
    ...
    public CompletableFuture<List<BusinessCatalogEntry>> queryBusinessCatalog(@NonNull ContactJidProvider contact, int productsLimit) {
        ...
        checkLoggedIn();
        return socketHandler.sendQuery("get", "w:biz:catalog", Node.ofChildren("product_catalog", Map.of("jid", contact, "allow_shop_source", "true"), Node.of("limit", String.valueOf(productsLimit).getBytes(StandardCharsets.UTF_8)), Node.of("width", "100".getBytes(StandardCharsets.UTF_8)), Node.of("height", "100".getBytes(StandardCharsets.UTF_8)))).thenApplyAsync(this::parseCatalog);
    }
    ...
    public CompletableFuture<byte[]> downloadMedia(@NonNull MessageInfo info) {
        ...
        checkLoggedIn();
        Validate.isTrue(info.message().category() == MessageCategory.MEDIA, "Expected media message, got: %s(%s)", info.message().category(), info.message().type());
    ...
    public CompletableFuture<MessageInfo> requireMediaReupload(@NonNull MessageInfo info) {
        ...
        var rmrAttributes = Attributes.of().put("jid", info.chatJid()).put("from_me", String.valueOf(info.fromMe())).put("participant", info.senderJid(), () -> !Objects.equals(info.chatJid(), info.senderJid())).toMap();
        var node = Node.ofChildren("receipt", Map.of("id", info.key().id(), "to", socketHandler.store().jid().toWhatsappJid(), "type", "server-error"), Node.ofChildren("encrypt", Node.of("enc_p", ciphertext), Node.of("enc_iv", retryIv)), Node.ofAttributes("rmr", rmrAttributes));
        return socketHandler.send(node, result -> result.hasDescription("notification")).thenApplyAsync(result -> parseMediaReupload(info, mediaMessage, retryKey, retryIdData, result));
    }
    ...
    private MessageInfo parseMediaReupload(MessageInfo info, MediaMessage mediaMessage, byte[] retryKey, byte[] retryIdData, Node node) {
        ...
        var encryptNode = node.findNode("encrypt").orElseThrow(() -> new NoSuchElementException("Missing encrypt node in media reupload"));
        var mediaPayload = encryptNode.findNode("enc_p").flatMap(Node::contentAsBytes).orElseThrow(() -> new NoSuchElementException("Missing encrypted payload node in media reupload"));
        var mediaIv = encryptNode.findNode("enc_iv").flatMap(Node::contentAsBytes).orElseThrow(() -> new NoSuchElementException("Missing encrypted iv node in media reupload"));
    ...
    public CompletableFuture<GroupMetadata> createCommunity(@NonNull String subject, String body) {
        ...
        checkLoggedIn();
        var entry = Node.ofChildren("create", Map.of("subject", subject), Node.ofChildren("description", Map.of("id", socketHandler.store().nextTag()), Node.of("body", requireNonNullElse(body, "").getBytes(StandardCharsets.UTF_8))), Node.ofAttributes("parent", Map.of("default_membership_approval_mode", "request_required")));
        return socketHandler.sendQuery(GROUP.toJid(), "set", "w:g2", entry).thenApplyAsync(response -> Optional.ofNullable(response).flatMap(node -> node.findNode("group")).orElseThrow(() -> new NoSuchElementException("Missing community response, something went wrong: %s".formatted(findErrorNode(response))))).thenApplyAsync(GroupMetadata::of);
    }
    ...
    public CompletableFuture<Whatsapp> unlinkCompanions() {
        ...
        return socketHandler.sendQuery("set", "md", Node.ofAttributes("remove-companion-device", Map.of("all", true, "reason", "user_initiated"))).thenApply(ignored -> this);
    }
    ...
    public CompletableFuture<Whatsapp> unlinkCompanion(@NonNull ContactJid companion) {
        if (companion == null) {
            throw new java.lang.NullPointerException("companion is marked non-null but is null");
        }
        Validate.isTrue(socketHandler.options().clientType() == ClientType.APP_CLIENT, "Companions cannot be unlinked from the web client");
        Validate.isTrue(companion.hasAgent(), "Expected companion, got jid without agent: %s", companion);
        return socketHandler.sendQuery("set", "md", Node.ofAttributes("remove-companion-device", Map.of("jid", companion, "reason", "user_initiated"))).thenApply(ignored -> this);
    }
    ...
    public CompletableFuture<CompanionLinkResult> linkCompanion(byte @NonNull [] qrCode) {
        if (qrCode == null) {
            throw new java.lang.NullPointerException("qrCode is marked non-null but is null");
        }
        try {
    ...
    public CompletableFuture<CompanionLinkResult> linkCompanion(@NonNull String qrCodeData) {
        if (qrCodeData == null) {
            throw new java.lang.NullPointerException("qrCodeData is marked non-null but is null");
        }
        ...
        var deviceIdentity = DeviceIdentity.builder().rawId(KeyHelper.agent()).keyIndex(KeyHelper.keyIndex()).timestamp(timestamp).build();
        var deviceIdentityBytes = Protobuf.writeMessage(deviceIdentity);
        var accountSignatureMessage = Bytes.of(ACCOUNT_SIGNATURE_HEADER).append(deviceIdentityBytes).append(advIdentity).toByteArray();
        var accountSignature = Curve25519.sign(socketHandler.keys().identityKeyPair().privateKey(), accountSignatureMessage, true);
        var signedDeviceIdentity = SignedDeviceIdentity.builder().accountSignature(accountSignature).accountSignatureKey(socketHandler.keys().identityKeyPair().publicKey()).details(deviceIdentityBytes).build();
        var signedDeviceIdentityBytes = Protobuf.writeMessage(signedDeviceIdentity);
        var deviceIdentityHmac = SignedDeviceIdentityHMAC.builder().hmac(Hmac.calculateSha256(signedDeviceIdentityBytes, identityKey)).details(signedDeviceIdentityBytes).build();
        var knownDevices = socketHandler.store().linkedDevices().stream().map(ContactJid::agent).toList();
        var keyIndexList = KeyIndexList.builder().rawId(deviceIdentity.rawId()).timestamp(deviceIdentity.timestamp()).validIndexes(knownDevices).build();
        var keyIndexListBytes = Protobuf.writeMessage(keyIndexList);
        var deviceSignatureMessage = Bytes.of(DEVICE_MOBILE_SIGNATURE_HEADER).append(keyIndexListBytes).toByteArray();
        var keyAccountSignature = Curve25519.sign(socketHandler.keys().identityKeyPair().privateKey(), deviceSignatureMessage, true);
        var signedKeyIndexList = SignedKeyIndexList.builder().accountSignature(keyAccountSignature).details(keyIndexListBytes).build();
        return socketHandler.sendQuery("set", "md", Node.ofChildren("pair-device", Node.of("ref", ref), Node.of("pub-key", publicKey), Node.of("device-identity", Protobuf.writeMessage(deviceIdentityHmac)), Node.of("key-index-list", Map.of("ts", timestamp), Protobuf.writeMessage(signedKeyIndexList)))).thenComposeAsync(result -> handleCompanionPairing(result, deviceIdentity.keyIndex()));
    }
    ...
    private CompletableFuture<CompanionLinkResult> handleCompanionPairing(Node result, int keyId) {
        try {
            if (result.attributes().hasKey("type", "error")) {
                var error = result.findNode("error").filter(entry -> entry.attributes().hasKey("text", "resource-limit")).map(entry -> CompanionLinkResult.MAX_DEVICES_ERROR).orElse(CompanionLinkResult.RETRY_ERROR);
                return CompletableFuture.completedFuture(error);
            }
            var device = result.findNode("device").flatMap(entry -> entry.attributes().getJid("jid")).orElse(null);
            if (device == null) {
            ...
            return socketHandler.sendQuery("get", "encrypt", Node.ofChildren("key", Node.ofAttributes("user", Map.of("jid", device)))).thenComposeAsync(encryptResult -> handleCompanionEncrypt(encryptResult, device, keyId));
    ...
    private CompletableFuture<CompanionLinkResult> handleCompanionEncrypt(Node result, ContactJid companion, int keyId) {
        ...
        var initialSecurityMessage = ProtocolMessage.builder().protocolType(ProtocolMessageType.INITIAL_SECURITY_NOTIFICATION_SETTING_SYNC).initialSecurityNotificationSettingSync(InitialSecurityNotificationSettingSync.of(true)).build();
        var appStateKeys = IntStream.range(0, 5).mapToObj(index -> createAppKey()).toList();
        var appStateSyncKeyShare = AppStateSyncKeyShare.builder().keys(appStateKeys).build();
        var appStateMessage = ProtocolMessage.builder().protocolType(ProtocolMessageType.APP_STATE_SYNC_KEY_SHARE).appStateSyncKeyShare(appStateSyncKeyShare).build();
        var initialBootstrap = HistorySync.builder().conversations(socketHandler.store().chats()).syncType(HistorySync.Type.INITIAL_BOOTSTRAP).build();
        var initialBootstrapMessage = createHistoryProtocolMessage(initialBootstrap, Type.INITIAL_BOOTSTRAP);
        var pushNamesData = socketHandler.store().contacts().stream().map(entry -> entry.chosenName() == null ? null : new PushName(entry.jid().toString(), entry.chosenName())).filter(Objects::nonNull).toList();
        var pushNames = HistorySync.builder().pushNames(pushNamesData).syncType(HistorySync.Type.PUSH_NAME).build();
        var pushNamesMessage = createHistoryProtocolMessage(pushNames, Type.PUSH_NAME);
        return socketHandler.sendPeerMessage(companion, initialSecurityMessage).thenComposeAsync(ignored -> socketHandler.sendPeerMessage(companion, appStateMessage)).thenComposeAsync(ignored -> initialBootstrapMessage.thenAcceptAsync(message -> socketHandler.sendPeerMessage(companion, message))).thenComposeAsync(ignored -> pushNamesMessage.thenAcceptAsync(message -> socketHandler.sendPeerMessage(companion, message))).thenApplyAsync(ignored -> CompanionLinkResult.SUCCESS);
    }
    ...
    private CompletableFuture<ProtocolMessage> createHistoryProtocolMessage(HistorySync historySync, HistorySyncNotification.Type type) {
        ...
        return Medias.upload(syncBytes, AttachmentType.HISTORY_SYNC, socketHandler.store().mediaConnection()).thenApplyAsync(upload -> createHistoryProtocolMessage(upload, type));
    }

    private ProtocolMessage createHistoryProtocolMessage(MediaFile upload, HistorySyncNotification.Type type) {
        var notification = HistorySyncNotification.builder().mediaSha256(upload.fileSha256()).mediaEncryptedSha256(upload.fileEncSha256()).mediaKey(upload.mediaKey()).mediaDirectPath(upload.directPath()).mediaSize(upload.fileLength()).syncType(type).build();
        return ProtocolMessage.builder().protocolType(ProtocolMessageType.HISTORY_SYNC_NOTIFICATION).historySyncNotification(notification).build();
    }

    private AppStateSyncKey createAppKey() {
        return AppStateSyncKey.builder().keyId(AppStateSyncKeyId.of(KeyHelper.appKeyId())).keyData(createAppKeyData()).build();
    }

    private AppStateSyncKeyData createAppKeyData() {
        return AppStateSyncKeyData.builder().keyData(SignalKeyPair.random().publicKey()).fingerprint(createAppKeyFingerprint()).timestamp(Clock.nowSeconds()).build();
    }

    private AppStateSyncKeyFingerprint createAppKeyFingerprint() {
        return AppStateSyncKeyFingerprint.builder().rawId(ThreadLocalRandom.current().nextInt(0, 10)).currentIndex(ThreadLocalRandom.current().nextInt(0, 10)).deviceIndexes(List.of(0)).build();
    }
